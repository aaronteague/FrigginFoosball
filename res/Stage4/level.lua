...
function loadAnnouncerSounds()
 announcer:LoadFile(0, "res/Stage4/intro.ogg")
 announcer:LoadFile(1, "res/Stage4/p_wins.ogg")
 announcer:LoadFile(2, "res/Stage4/pLoses.ogg")
end
