...
void main()
{
	...
	/// added by me ///
//	const float maxDistance = 10; //distance from camera at which fog become completely opaque
//	const float fogDensity = 6.0;
//	
//	if(gl_FragCoord.z / gl_FragCoord.w < maxDistance)
//		discard;

//	float cut = (gl_FragCoord.z / gl_FragCoord.w) / maxDistance;

//	if(gl_FragCoord.z < 0.001)
//		discard;
//	float fogAmount = z * fogDensity;   
//	vec4 fogColour = {0, 0, 0, 0};
